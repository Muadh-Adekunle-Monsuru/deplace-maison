...
export default function Section4() {
	...
	return (
		<div className='py-20 flex justify-center lg:justify-end mb-20'>
			<div className='relative w-1/2 flex gap-5'>
					...
					{value && (
						<div className='flex gap-5' key={'first'}>
							...
							<motion.p
								...
								className='font-mulish w-1/2 text-xs blur-[0.3px] font-medium'
							>
								{values[0].text}
							</motion.p>
						</div>
